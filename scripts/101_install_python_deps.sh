...
GUARD_FILE="___PYTHON_DEPS_INSTALLED___"
...
then
    ...
    python remove_package_from_requirements_txt.py onnx_requirements.txt --no-protobuf
    # ONNX Script
    ...
    python remove_package_from_requirements_txt.py onnxruntime_requirements.txt --no-onnx --no-protobuf
